...
static bc_num _bc_new_num_nonzeroed_ex_internal(size_t int_vsize, size_t frac_vsize, size_t scale, bool persistent)
{
	...
	temp->n_vectors = (char *) temp + sizeof(bc_struct);
	return temp;
}
...
bc_num _bc_new_num_ex(size_t length, size_t scale, bool persistent)
{
	...
	bc_num temp = _bc_new_num_nonzeroed_ex_internal(int_vsize, frac_vsize, scale, persistent);
	return bc_set_zeros(temp);
}

bc_num _bc_new_num_nonzeroed_ex(size_t length, size_t scale, bool persistent)
{
	return _bc_new_num_nonzeroed_ex_internal(BC_LENGTH_TO_VECTOR_SIZE(length), BC_LENGTH_TO_VECTOR_SIZE(scale), scale, persistent);
}

bc_num _bc_new_num_with_vsize_ex(size_t int_vsize, size_t frac_vsize, size_t scale, bool persistent)
{
	bc_num temp = _bc_new_num_nonzeroed_ex_internal(int_vsize, frac_vsize, scale, persistent);
	return bc_set_zeros(temp);
}

bc_num _bc_new_num_nonzeroed_with_vsize_ex(size_t int_vsize, size_t frac_vsize, size_t scale, bool persistent)
{
	return _bc_new_num_nonzeroed_ex_internal(int_vsize, frac_vsize, scale, persistent);
}
...
{
	BCG(_zero_) = _bc_new_num_with_vsize_ex(1, 0, 0, 1);
	BCG(_one_) = _bc_new_num_nonzeroed_with_vsize_ex(1, 0, 0, 1);
	BCG(_one_)->n_vectors[0] = 1;
	BCG(_two_) = _bc_new_num_nonzeroed_with_vsize_ex(1, 0, 0, 1);
