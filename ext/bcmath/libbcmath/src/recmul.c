...
{
	BC_VECTOR tmp = n1->n_vector[0] * n2->n_vector[0];
	prod->n_vector[0] = tmp % BC_VECTOR_BOUNDARY_NUM;
	prod->n_vector[1] = tmp / BC_VECTOR_BOUNDARY_NUM;
}
...
static void bc_standard_mul(bc_num n1, size_t n1_vsize, bc_num n2, size_t n2_vsize, bc_num prod)
{
	...
	BC_VECTOR *v1ptr = n1->n_vector;
	BC_VECTOR *v2ptr = n2->n_vector;
	BC_VECTOR *vpptr = prod->n_vector;
