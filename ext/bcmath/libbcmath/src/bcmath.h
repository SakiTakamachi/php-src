...
#define bc_new_num_with_vsize(int_vsize, frac_vsize, scale)				_bc_new_num_with_vsize_ex((int_vsize) (frac_vsize), (scale), 0)
#define bc_new_num_nonzeroed_with_vsize(int_vsize, frac_vsize, scale)	_bc_new_num_nonzeroed_with_vsize_ex((int_vsize) (frac_vsize), (scale), 0)
